...
const PROJECT_LINKS: Record<string, string> = {
  ...
  "chat application":
    "https://github.com/DavidBatoDev/chat-application-mongodb",
  ...
  "gdg xparky":
    "https://github.com/DavidBatoDev/gdg-web-development-classroom-api",
  ...
  "california housing":
    "https://github.com/DavidBatoDev/house-price-prediction-pytorch",
  "object detection": "https://github.com/DavidBatoDev/object-detection-opencv",
  "data structure":
    "https://github.com/DavidBatoDev/data-structure-algo-visualization",
  "mario theme":
    "https://github.com/DavidBatoDev/data-structure-algo-mario-theme",
...
const DAVID_RESUME = {
  ...
  experience: [
    ...
    },
    {
      ...
      organization:
        "Google Developer Students Club, Polytechnic University of the Philippines",
  ...
  projects: [
    {
      name: "IskoChatAI",
      technologies:
        "NextJS, TypeScript, Gemini API, TailwindCSS, Google Custom Search API",
      description: [
  ...
  certifications: [
    {
      ...
      date: "March 2025",
      description:
        "Fundamentals of AWS cloud computing, architecture, and services",
    },
    {
      ...
      date: "March 2025",
      description:
        "LLM development, optimization, fine-tuning, reinforcement learning, AI applications",
    },
    {
      name: "Python Programmer Bootcamp",
      issuer: "365 Data Science",
      description:
        "Python fundamentals to advanced concepts, including NumPy, Pandas, and Matplotlib",
    },
  ],
};
...
const getAdditionalDetails = (query: string): string => {
  ...
  if (
    ...
    query.includes("alertech") ||
    query.includes("arduino") ||
    query.includes("fire") ||
    query.includes("chat")
  ) {
    const relevantProjects = DAVID_RESUME.projects.filter(
      (p) =>
        query.includes(p.name.toLowerCase()) ||
        p.technologies
          .toLowerCase()
          .split(", ")
          .some((tech) => query.includes(tech.toLowerCase())),
    );
  ...
  if (
    ...
    query.includes("work") ||
    query.includes("job") ||
    query.includes("electrif") ||
    query.includes("gdsc") ||
    query.includes("pup")
  ) {
    const relevantExperience = DAVID_RESUME.experience.filter(
      (e) =>
